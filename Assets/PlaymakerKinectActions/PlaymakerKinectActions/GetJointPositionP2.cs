...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class GetJointPositionP2 : FsmStateAction
	{
		...
		{		
			...
			if(manager != null && KinectManager.IsKinectInitialized() && manager.GetPlayer2ID() > 0)
			{
				uint userId = manager.GetPlayer2ID();
