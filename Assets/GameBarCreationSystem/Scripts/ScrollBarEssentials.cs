...
class ScrollBarEssentials
{
    ...
    public virtual void DrawBar()
    {
        ...
        {
            if (ScrollBarTextureDimens.width != 0 && ScrollBarTextureDimens.height != 0)
                GUI.DrawTexture(new Rect(ScrollBarDimens.x + ScrollBarTextureDimens.x,
				                         ScrollBarDimens.y + ScrollBarTextureDimens.y + ScrollBarTextureDimens.height,
				                         -current_value * (ScrollBarTextureDimens.height / max_value),
				                         ScrollBarTextureDimens.width),
				                		 ScrollTexture);
            else
                GUI.DrawTexture(new Rect(ScrollBarDimens.x,
				                         ScrollBarDimens.y + ScrollBarDimens.height,
				                         -current_value * (ScrollBarDimens.height / max_value),
				                  		 ScrollBarBubbleTexture.width), ScrollTexture);
